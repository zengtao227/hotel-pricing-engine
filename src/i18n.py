...
TRANSLATIONS = {
    ...
    "revpar_trend": {"zh": "每间可售房收入趋势", "en": "RevPAR Trend", "de": "RevPAR-Trend", "fr": "Tendance RevPAR"},
    "avg_revpar_by_date": {"zh": "每日每间可售房收入", "en": "Average RevPAR by stay date", "de": "Durchschnittlicher RevPAR nach Aufenthaltstag", "fr": "RevPAR moyen par date de séjour"},
